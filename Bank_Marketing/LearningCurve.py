...
""" estimator = tree.DecisionTreeClassifier(
    criterion='entropy', splitter='best', max_depth=6, ccp_alpha=0.001, random_state=0) """
# NN
""" scaler = StandardScaler()
scaler.fit(x_data)
x_data = scaler.transform(x_data)
estimator = MLPClassifier(
            hidden_layer_sizes=(5), activation='logistic', solver='sgd', learning_rate_init=0.1, max_iter=10000, random_state=0) """
...
scaler.fit(x_data)
x_data = scaler.transform(x_data)
estimator = SVC(C=0.5, kernel='poly', gamma='auto', random_state=0) """
